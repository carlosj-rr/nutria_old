...
pop_size = 10 # For the moment, Multiple of 10
...
prob_grn_change = 0	 	# Probability that grn mutation will change grn structure
				# (i.e. it will create a new link or remove an existing one).
new_link_bounds = (-2,2)

# SELECTION PARAMETERS
min_reproducin = 0.1
prop_survivors = 0.5 # For the moment, it must result in a whole number when multiplied by the pop_size
tot_offspring = pop_size
select_strategy = "random" # For the moment, just "greedy" and "random"
